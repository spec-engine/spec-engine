// packages/engine/src/commands/docs.test.ts
//
...
import { createDocsFetchHandler, exitNoDocsRoot, resolveDocsRootFrom, runProbe } from "./docs";
...
describe("docs --probe / missing-root exits", () => {
  ...
  test("no docs root: exit 2 naming `bun run build:site`", async () => {
    ...
    const src = readFileSync(resolve(import.meta.dir, "docs.ts"), "utf8");
