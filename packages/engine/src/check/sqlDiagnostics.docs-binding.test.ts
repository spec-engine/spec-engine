// packages/engine/src/check/sqlDiagnostics.docs-binding.test.ts
//
...
// .ts line, comments included (same reason src/testing/specTag.ts exists):
...
import { collectDiagnostics } from "./sqlDiagnostics";
