// packages/engine/src/results/junit.test.ts
//
...
import { JUnitParseError, parseJUnit, type TestCaseResult } from "./junit";

const JUNIT_FIXTURES = join(import.meta.dir, "..", "testing", "fixtures", "junit");
