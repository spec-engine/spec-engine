// packages/engine/src/indexer/diagnostics.test.ts
//
...
// fixtures under packages/engine/src/testing/fixtures/diagnostics/ — one per
...
const FIXTURES_ROOT = resolve(import.meta.dir, "..", "testing", "fixtures", "diagnostics");
